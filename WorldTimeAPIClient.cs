...
namespace APIVerve
{
    public class WorldTimeAPIClient
    {
        ...
        public WorldTimeAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public WorldTimeAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(worldtimeQueryOptions options)
        {
            try
            {
                if (_isDebug)
